...
import heroImg1 from "@/assets/hero-kasvu-1.jpg";
import heroImg2 from "@/assets/hero-kasvu-2.jpg";
import heroImg3 from "@/assets/hero-kasvu-3.jpg";

const slides = [
  {
    image: heroImg1,
    title: "Myynti ja skaalaus",
    cta: "Katso kasvupolut",
    href: "#tilanteet",
  },
  {
    image: heroImg2,
    ...
    cta: "Aloita AI-polku",
    href: "#ratkaisuperheet",
  },
  {
    image: heroImg3,
    title: "Uudistuminen ja siirtymät",
    cta: "Aloita kartoitus",
    href: "#aloita",
  },
];

export function GrowthHeroCarousel() {
