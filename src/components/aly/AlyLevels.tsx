            ...
            >
              ...
              <div className="p-6 md:p-8 flex-1 border-t-2 md:border-t-0 md:border-l-2 border-primary/20">
                <div className="flex flex-wrap items-baseline gap-x-3 mb-1">
                  <span className="text-xs font-bold uppercase tracking-[0.16em] text-keuda-orange-deep">
                    Taso {i + 1} / 3
                  </span>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-5 mb-5 rounded-xl border border-border bg-muted/50 p-4 md:p-5">
                  <div>
                    <h4 className="text-[11px] font-bold uppercase tracking-[0.12em] text-keuda-orange-deep mb-2">Kenelle</h4>
                  ...
                  <div>
                    <h4 className="text-[11px] font-bold uppercase tracking-[0.12em] text-keuda-orange-deep mb-2">Mitä osaaminen tarkoittaa</h4>
                    <ul className="text-sm text-muted-foreground space-y-1 list-disc pl-4 marker:text-primary/50">
                      {level.content.map((c) => (
                        <li key={c}>{c}</li>
                      ))}
