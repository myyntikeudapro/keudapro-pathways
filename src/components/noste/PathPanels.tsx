...
function MaksullinenValmennusStep() {
  return (
    ...
    >
      ...
      <CtaLink href="https://calendar.google.com/calendar/appointments/schedules/AcZssZ14Dw7NAt63yAIEiGiboZjtx6D26SN0IZ_LD9_Cv5kPhkgRhLsAZySJ2q-GNTsMH5UTg00lKurU?gv=true">Varaa aika →</CtaLink>
    </StepCard>
  );
}
