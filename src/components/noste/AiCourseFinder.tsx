...
const LEVELS: {
...
}[] = [
  {
    ...
    tagline: "Tekoälyn käytännön hyödyntäminen omassa työssä — sopii kaikille, jotka haluavat ottaa tekoälyn osaksi arkeaan.",
    icon: Sparkles,
  ...
  },
  {
    ...
    short: "AI-Manager",
    tagline: "Tekoälyn käyttöönotto tiimeissä ja prosesseissa — soveltuu kaikille tekoälyn käyttöönottoa vetäville, ei vaadi esihenkilöasemaa.",
    icon: Users,
  ...
  },
  {
    ...
    name: "Tekoälyjohtaja",
    short: "AI-Director",
    tagline: "Strateginen tekoälyjohtaminen ja organisaation uudistus — sopii kaikille, jotka haluavat rakentaa tekoälystrategian ja johtaa muutosta.",
    icon: Crown,
